...
function saveBookmark(e) {
    ...
    // تحقق من أن اسم الموقع يحتوي على حروف فقط
    ...
    // تحقق من أن رابط الموقع يحتوي على ".com"
...
function fetchBookmarks() {
    ...
    bookmarksTable.innerHTML = ''; // مسح محتوى الجدول
    ...
    bookmarks.forEach((bookmark, index) => {
        const rowHtml = `
            <tr>
                <td>${index + 1}</td>
                <td>${bookmark.name}</td>
                <td><button class="btn btn-outline-info px-4"  onclick="visitSite('${bookmark.url}')">
